...
import SkillsController from './components/skills/SkillsController';
...
function App() {
  ...
  <Route path="/skills" element={<PrivateRouteWrapper><SkillsController /></PrivateRouteWrapper>} />
  <Route path="/matching" element={<PrivateRouteWrapper><Matching /></PrivateRouteWrapper>} />
  <Route path="/terms" element={<TermsAndConditions />} />
  <Route path="/login" element={<LoginPage />} />
  <Route path="/signup" element={<SignupPage />} />
  <Route path="/profile" element={<PrivateRouteWrapper><UserProfile /></PrivateRouteWrapper>} />
</Routes>
