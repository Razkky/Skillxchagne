...
function GameRules() {
  return (
    ...
    <h2 className="text-2xl mb-4 font-bold text-white border-b pb-2 border-gray-700">Game Legend</h2>
    ...
    <div className="flex items-center mb-4">
        ...
        <p className="text-gray-400 flex-grow">Teaching Points: Earn these points by selecting skills as "Teaching." Showcase your ability to educate others.</p>
    </div>
    <div className="flex items-center mb-4">
        ...
        <p className="text-gray-400 flex-grow">Learning Points: Accumulate these points by designating skills as "Learning." Demonstrate your dedication to acquiring new knowledge and skills.</p>
    </div>
